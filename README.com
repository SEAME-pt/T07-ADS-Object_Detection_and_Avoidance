...
In this project, you will be exposed to the intersection of virtual simulations and real-world applications. You will delve deep into the mechanisms of the Lane Keeping Assist System (LKAS), a pivotal Level 1 autonomous driving feature. Using advanced simulation platforms and actual hardware, you will design, test, and implement an LKAS that can operate both virtually and in the real world.
...
In this project, every team must host ONE final submission demo & presentation (max. 30 mins) in front of all the other teams. Each team must find a way to organize this presentation, ensuring that all other teams can be present and participate actively. (Please work out what date/time works best for every team.) The date and time of each team's presentation must be communicated to staff well in advance (at least a week in advance). It is the presenting team's responsibility to ensure all forms are filled in **immediately** after the presentation.
...
2. For evaluatees (the presenters) - Fill in [this form](https://docs.google.com/forms/d/e/1FAIpQLSfYipLAaXFaAm23ZdW8ruXCfQDOXikLYwhxXwpve9C5kZoZvw/viewform?usp=sf_link) for general feedback on your work in this project.
...
6. **Final Report**: A final report that summarizes the project and provides a detailed overview of the work that was completed, the results achieved, and the challenges encountered. The report should also include a discussion of future work that could extend or improve the autonomous lane detection system.
...
These references are just examples. Participants are encouraged to explore other open-source tools and resources that may be more suitable for their specific needs and requirements. Participants should be prepared to research and evaluate different open-source tools and resources and make informed decisions about which to use for their projects.
